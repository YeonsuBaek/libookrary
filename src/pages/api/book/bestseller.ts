export default async function async(req: any, res: any) {
  try {
    ...
    const aladinAPIUrl = `http://www.aladin.co.kr/ttb/api/ItemList.aspx?ttbkey=${KEY}&&QueryType=bestseller&MaxResults=10&start=1&SearchTarget=Book&Output=js&Version=20131101`
